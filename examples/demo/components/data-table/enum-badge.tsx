...
const ENUM_BADGE_STYLES: Record<DatoolEnumBadgeColor, string> = {
  ...
  blue: "bg-blue-50/90 text-blue-700 dark:bg-blue-400/10 dark:text-blue-200",
  coral: "bg-rose-50/90 text-rose-700 dark:bg-rose-400/10 dark:text-rose-200",
  cyan: "bg-cyan-50/90 text-cyan-700 dark:bg-cyan-400/10 dark:text-cyan-200",
  emerald:
  ...
  lime: "bg-lime-50/90 text-lime-700 dark:bg-lime-400/10 dark:text-lime-200",
  orange:
    "bg-orange-50/90 text-orange-700 dark:bg-orange-400/10 dark:text-orange-200",
  pink: "bg-pink-50/90 text-pink-700 dark:bg-pink-400/10 dark:text-pink-200",
  purple:
  ...
  rose: "bg-rose-50/90 text-rose-700 dark:bg-rose-400/10 dark:text-rose-200",
  sky: "bg-sky-50/90 text-sky-700 dark:bg-sky-400/10 dark:text-sky-200",
  stone: "bg-stone-50/95 text-stone-700 dark:bg-white/5 dark:text-stone-100",
  teal: "bg-teal-50/90 text-teal-700 dark:bg-teal-400/10 dark:text-teal-200",
  violet:
...
const ENUM_BADGE_OUTLINE_STYLES: Record<DatoolEnumBadgeColor, string> = {
  ...
  blue: "border-2 border-blue-300 text-blue-800 dark:border-blue-400/50 dark:text-blue-200 bg-background",
  coral:
    "border-2 border-rose-300 text-rose-800 dark:border-rose-400/50 dark:text-rose-200 bg-background",
  cyan: "border-2 border-cyan-300 text-cyan-800 dark:border-cyan-400/50 dark:text-cyan-200 bg-background",
  emerald:
  ...
  lime: "border-2 border-lime-300 text-lime-800 dark:border-lime-400/50 dark:text-lime-200 bg-background",
  orange:
    "border-2 border-orange-300 text-orange-800 dark:border-orange-400/50 dark:text-orange-200 bg-background",
  pink: "border-2 border-pink-300 text-pink-800 dark:border-pink-400/50 dark:text-pink-200 bg-background",
  purple:
  ...
  rose: "border-2 border-rose-300 text-rose-800 dark:border-rose-400/50 dark:text-rose-200 bg-background",
  ...
  teal: "border-2 border-teal-300 text-teal-800 dark:border-teal-400/50 dark:text-teal-200 bg-background",
  violet:
...
function resolveEnumBadgeStyle(
  ...
  const optionIndex =
    options?.findIndex(
      (option) => normalizeEnumValue(option) === normalizedValue
    ) ?? -1
...
export function EnumBadge({
  ...
  return (
    <span
      className={cn(
        "rounded-md px-2 py-1 text-sm font-medium inline-flex max-w-full items-center leading-none whitespace-nowrap shadow-[0_1px_2px_rgba(15,23,42,0.04)] dark:shadow-none",
